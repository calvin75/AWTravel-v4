...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:Panel ID="PanelPredictInputs" runat="server" Visible="true">
            <p><b class="step">Exercise 2-5</b>: Inputs</p>
            <table>
                <tr><td>from:<input type="text" id="tb_from" value="SAN" /></tr>
                <tr><td>to:<input type="text" id="tb_to" value="SEA" /></tr>
                <tr><td>date:<input type="text" id="tb_date" value="11/15/2015" /></tr>
                <tr><td>time:<input type="text" id="tb_time" value="5:00 PM" /></tr>
                <tr><td>carrier:<input type="text" id="tb_carrier" /></tr>
                <tr><td><input type="button" id="bPredictDelay" value="Predict Delay" /></td></tr>
            </table>
        </asp:Panel>
    </div>
    ...
    <div>
        <asp:Panel ID="PanelPredictResults" runat="server" Visible="true">
            ...
            <table>
                <tr><td>weather forecast:<br /><img id="weatherForecast" src="http://icons.wxug.com/i/c/k/partlycloudy.gif" /></tr>
                <tr><td>delay prediction: <br /><span id="predictionDelay">expect delays (73% confidence)</span></tr>
            </table>
        </asp:Panel>
    </div>
    ...
    <div>
        <asp:Panel ID="Panel1" runat="server" Visible="true">
            ...
            <table>
                <tr><td>URI to blob for scoring:<input type="text" id="tb_blobToScore" value="" /></tr>
                <tr><td><input type="button" id="bBatchScore" value="Batch Score File" /></td></tr>
            </table>
        </asp:Panel>
    </div>
